define(["testingTools", "app/impressive", "commonCanvas"], function(testingTools,impressive, commonCanvas){
    var image = document.getElementById("target-image");
    var imageCanvas = commonCanvas.createCanvasByImage(image, 100000);
    document.querySelector("#shell main").appendChild(imageCanvas);
